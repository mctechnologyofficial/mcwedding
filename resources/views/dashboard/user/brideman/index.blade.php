            ...
            <div class="card custom-card">
                <div class="card-body">
                    ...
                    @forelse ($brideman as $data)
                        ...
                        <form action="{{ route('user.brideman.update') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="form-group">
                                <label for="exampleInputPassword1">Tentang Mempelai Pria</label>
                    ...
                    @empty
                        ...
                        <form action="{{ route('user.brideman.store') }}" method="POST" enctype="multipart/form-data">
                            @csrf
